  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><?php echo anchor('recipient/offers/index', '<i class="fa fa-plus-circle"></i>Offers'); ?></li>
        <li><?php echo anchor('recipient/offers/myoffers', '<i class="fa fa-plus-circle"></i>My Offers'); ?></li>
      </ul>
